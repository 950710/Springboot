package com.twq.domain;


import com.twq.mbg.model.UmsIntegrationConsumeSetting;
import com.twq.mbg.model.UmsMemberReceiveAddress;
...
public class ConfirmOrderResult {
    //包含优惠信息的购物车信息
    private List<com.twq.domain.CartPromotionItem> cartPromotionItemList;
    //用户收货地址列表
    private List<UmsMemberReceiveAddress> memberReceiveAddressList;
    //用户可用优惠券列表
    private List<com.twq.domain.SmsCouponHistoryDetail> couponHistoryDetailList;
    //积分使用规则
    ...
    public List<com.twq.domain.CartPromotionItem> getCartPromotionItemList() {
        return cartPromotionItemList;
    }

    public void setCartPromotionItemList(List<com.twq.domain.CartPromotionItem> cartPromotionItemList) {
    ...
    public List<com.twq.domain.SmsCouponHistoryDetail> getCouponHistoryDetailList() {
        return couponHistoryDetailList;
    }

    public void setCouponHistoryDetailList(List<com.twq.domain.SmsCouponHistoryDetail> couponHistoryDetailList) {
